...
public class StudentSpecification {
    ...
    public static Specification<Student> filter(StudentFilterDTO dto) {

        return (root, query, cb) -> {

            var predicate = cb.conjunction();

            if (dto.getFrom_date() != null && !dto.getFrom_date().isBlank()) {
            ...
            if (dto.getTo_date() != null && !dto.getTo_date().isBlank()) {
